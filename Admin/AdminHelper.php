...
//    }
	 ...
	 * Method is completely rewritten to improve code readability
	 *
	 * @throws \RuntimeException
	 *
	 * @param \Sonata\AdminBundle\Admin\AdminInterface $admin
...
//    }
	 ...
	 */
	public function addNewInstance(AdminInterface $admin, FieldDescriptionInterface $elementId)
	{
		...
		if ($collection instanceof ArrayCollection) {
			...
			throw new \InvalidArgumentException(sprintf('%s is not a valid Collection class', get_class($collection)));
		}
